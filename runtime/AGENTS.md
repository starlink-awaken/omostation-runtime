...
- Log files are the primary debugging resource for runtime issues
- Boundary YAML files define the contract for what belongs in runtime space
- Agent session data is managed by the agent runtime system
